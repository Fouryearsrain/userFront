  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <header class="comm-title">
        <h2 class="fl tac" >
          <span class="c-333" margin-right="200px">全部历史课程</span>
        </h2>
      </header>
...
export default {
  ...
  methods: {
    //查询课程列表
    initCourse() {
      course.getHistoryCourseList(1, 8, this.searchObj).then((response) => {
    ...
    gotoPage(page) {
      this.page = page;
      course.getHistoryCourseList(page, 8, this.searchObj).then((response) => {
        this.data = response.data.data;
      });
    },
  },
