  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <header class="comm-title">
        <h2 class="fl tac" >
          <span class="c-333" margin-right="200px">全部课程</span>
        </h2>
      </header>
...
export default {
  ...
  methods: {
    ...
    initCourse() {
      ...
      course.getPageCourseList(1, 8, this.searchObj).then((response) => {
        this.data = response.data.data;
      });
      console.log("debug init course")
    ...
    gotoPage(page) {
      this.page = page;
      course.getPageCourseList(page, 8, this.searchObj).then((response) => {
        this.data = response.data.data;
      });
    },
  },
